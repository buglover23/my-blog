                    ...
                    {imageFileUploadProgress && (
                        <CircularProgressbar value={imageFileUploadProgress || 0}
                            ...
                            styles={{
                                ...
                                path: {
                                    stroke: `rgb(214, 128, 96, ${imageFileUploadProgress / 100})`
                                }
                            }}
                        />
                    )}
                    <img src={iamgeFileUrl || currentUser.profilePicture} alt="user profile picture" className={`rounded-full w-full h-full object-cover border-4 border-[#FFBE98] ${imageFileUploadProgress && imageFileUploadProgress < 100 && 'opacity-60'}`} />
                </div>
